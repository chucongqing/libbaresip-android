...
MODULES := "auresamp;fakevideo;webrtc_aecm;augain;aaudio;dtls_srtp;opus;g711;g722;gzrtp;stun;turn;ice;presence;mwi;account;natpmp;srtp;uuid;sndfile;debug_cmd;avcodec;avformat;snapshot"
