...
download-sources:
	...
	git clone https://git.xswitch.cn/xyt/baresip.git -b k120-and-update --single-branch baresip
	...
	git clone https://git.xswitch.cn/xswitch/re.git -b k120-and-update --single-branch re
